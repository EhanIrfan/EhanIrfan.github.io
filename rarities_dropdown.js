...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function populateDropdown(filteredOptions) {
        ...
        filteredOptions.forEach(option => {
            ...
            checkbox.id = `rarities-option-${option}`;
            ...
            label.htmlFor = `rarities-option-${option}`;
    ...
    function updateSelectedOptionsDisplay() {
        ...
        selectedOptions.forEach(option => {
            ...
            tag.addEventListener('click', () => {
                ...
                const checkbox = document.getElementById(`rarities-option-${option}`);
                if (checkbox) {
    ...
    document.addEventListener('click', (event) => {
        if (!event.target.closest('.rarities-dropdown')) {
            closeDropdown();
        }
    });
    ...
    document.getElementById("rarities-dropdown-list").addEventListener("click", function(event) {
